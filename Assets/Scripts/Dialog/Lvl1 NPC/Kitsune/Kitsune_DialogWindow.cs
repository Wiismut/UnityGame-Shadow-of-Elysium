...
namespace Dialogue {
    public class Kitsune_DialogWindow : MonoBehaviour {
        ...
        private void Awake()
        {
            ...
            _dialogueStory = FindObjectOfType<Kitsune_DialogStory>();

            if (_dialogueStory == null)
            {
                Debug.LogError("Kitsune_DialogStory не найдено");
                return;
            }
        ...
        {
            var localizedString = new LocalizedString("DialogKitsune", key);
