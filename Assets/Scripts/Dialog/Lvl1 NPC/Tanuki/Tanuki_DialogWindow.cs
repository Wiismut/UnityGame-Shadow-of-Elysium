...
namespace Dialogue {
    public class Tanuki_DialogWindow : MonoBehaviour {
        ...
        private void Awake()
        {
            ...
            _dialogueStory = FindObjectOfType<Tanuki_DialogStory>();

            if (_dialogueStory == null)
            {
                Debug.LogError("Tanuki_DialogStory не найдено");
                return;
            }
        ...
        {
            var localizedString = new LocalizedString("DialogTanuki", key);
