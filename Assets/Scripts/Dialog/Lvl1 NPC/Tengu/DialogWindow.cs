...
namespace Dialogue {
    public class DialogWindow : MonoBehaviour {
        ...
        private void Awake()
        {
            ...
            _dialogueStory = FindObjectOfType<DialogStory>();
        ...
        private void ChangeAnswers(DialogStory.Story story)
        {
            ...
            {
                Debug.LogWarning("GameObject is not active, cannot start coroutine.");
                return;
            }
        ...
        {
            var localizedString = new LocalizedString("DialogTengu", key);
