...
namespace Dialogue {
    public class Sirin_DialogWindow : MonoBehaviour {
        ...
        private void Awake()
        {
            ...
            _dialogueStory = FindObjectOfType<Sirin_DialogStory>();

            if (_dialogueStory == null)
            {
                Debug.LogError("Sirin_DialogStory не найдено");
                return;
            }
        ...
        {
            var localizedString = new LocalizedString("DialogSirin", key);
