...
namespace Dialogue {
    public class Mermaid_DialogWindow : MonoBehaviour {
        ...
        private void Awake()
        {
            ...
            _dialogueStory = FindObjectOfType<Mermaid_DialogStory>();
        ...
        {
            var localizedString = new LocalizedString("DialogMermaid", key);
