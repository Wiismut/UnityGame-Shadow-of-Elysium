...
namespace Dialogue {
    public class Leshii_DialogWindow : MonoBehaviour {
        ...
        private void Awake()
        {
            ...
            _dialogueStory = FindObjectOfType<Leshii_DialogStory>();
        ...
        {
            var localizedString = new LocalizedString("DialogLeshii", key);
