...
public class Cat_Dialog : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        if (audioSource != null)
        {
            ...
            audioSource.clip = dialogCatSound;
        ...
        if (dialogCatSound == null)
        {
            Debug.LogError("звука нет");
        }

        _dialogueStory = FindObjectOfType<Cat_DialogStory>(true);
    ...
    {
        if (audioSource != null && dialogCatSound != null)
        {
            audioSource.PlayOneShot(dialogCatSound);
        }
        else
        {
            Debug.LogError("звука нет");
    ...
    private void OnDialogFinished(Cat_DialogStory.Story story)
    {
        if (_dialogActive)
        {
            _dialogActive = false;
