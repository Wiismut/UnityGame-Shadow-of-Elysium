...
public class StoneDialogManager : MonoBehaviour {
    ...
    public AudioClip dialogStoneSound;
    ...
    {
        if (audioSource != null && dialogStoneSound != null)
        {
            audioSource.PlayOneShot(dialogStoneSound);
        }
        else
        {
            Debug.LogError("звука нет");
